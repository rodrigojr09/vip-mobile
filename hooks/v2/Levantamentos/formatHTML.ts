import type { EmpresaType, FuncaoType, RiscoType, SetorType } from "@/types/Levantamento";
...
function getSetorHtml(setores: SetorType[]) {
            ...
            Number(setor.largura.replace(",", "."))
                ...
                <div class="font-bold flex h-min border border-black">
                    ...
                    <div class="w-[80%] p-2">
                        ...
                        <p>Iluminação Natural: <span class="font-normal">${setor.iluminacaoNatural
            }</span></p>
                        <p>Iluminação Artificial: <span class="font-normal">${setor.iluminacaoArtificial
            }</span></p>
                        <p>Ventilação Natural: <span class="font-normal">${setor.ventilacaoNatural
            }</span></p>
                        <p>Ventilação Artificial: <span class="font-normal">${setor.ventilacaoArtificial
            }</span></p>
...
function getFuncaoHtml(funcoes: FuncaoType[]) {
...
function getRiscoHtml(riscos: RiscoType[]) {
...
export function getHtml(empresa: EmpresaType) {
    return `
    <!DOCTYPE html>
<html lang="pt-BR">
<head>
