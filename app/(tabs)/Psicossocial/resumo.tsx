...
export default function Rascunho() {
	...
	const handleSignature = async (signature: string) => {
		...
		try {
			...
			psicossocial.setAssinatura(signature);
			nav.push("/Psicossocial/finalizado");
		} catch (error) {
	...
	return (
		<Container style={styles.container} scroller>
			<View style={styles.webviewWrapper}>
				<WebView
					source={{
						html: getRelatorioPsicossocialHtml(psicossocial),
					}}
			...
			<View style={styles.signatureWrapper}>
				<Signature
					...
					descriptionText={`Assinatura de: ${psicossocial.responsavel}`}
					clearText="Limpar"
