export const calculateIBUTG = (Tbu: string, Tg: string) => {
    if (!Tbu || !Tg || isNaN(parseFloat(Tbu)) || isNaN(parseFloat(Tg))) {
      return "";
    }
  ...
  export const calculateCalor = (IBUTG: string, Tg: string, Tbu: string, tempoTrabalho: string, metabolismoTrabalho: string) => {
    ...
    if (isNaN(ibutgValor) || isNaN(tgValor) || isNaN(tbuValor) || isNaN(tempoValor) || isNaN(metabolismoValor)) {
      return "";
    }
